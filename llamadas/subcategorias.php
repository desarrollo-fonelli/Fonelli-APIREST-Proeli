...
try {
  ...
  $cate = $dataObject->categoria;

    if (empty($cate)) {
        throw new Exception("El parametro 'categoria' no fue definido.");
      } 

        $url = "http://35.165.224.218:8089/subcategories";
        $data = array("categoria" => $cate);
