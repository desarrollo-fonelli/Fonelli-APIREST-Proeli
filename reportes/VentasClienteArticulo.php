 ...
 * @return array
 */
FUNCTION SelectClteCategoResumido($TipoUsuario,$Usuario,$OficinaDesde, 
$OficinaHasta,$FechaDesde,$FechaHasta,$ClienteDesde,$FilialDesde, 
$ClienteHasta,$FilialHasta,$LineaDesde,$LineaHasta,$ClaveDesde, 
$ClaveHasta,$CategoriaDesde,$SubcategoDesde,$CategoriaHasta,$SubcategoHasta,
$TipoArticulo,$TipoOrigen,$Pagina) 
{
  ...
  AND concat(a.va_num,a.va_fil) >= :strClteInic
  AND concat(a.va_num,a.va_fil) <= :strClteFinal 
  ...
  try {
    ...
    ORDER BY va_num,va_fil,va_cat,va_scat ";
    ...
    ORDER BY va_num,va_fil,va_cat,va_scat,va_lin,va_clave ";
