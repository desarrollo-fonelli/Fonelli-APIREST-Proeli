...
FUNCTION SelectPedidos($TipoUsuario, $Usuario, $ClienteCodigo, $ClienteFilial, $PedidoLetra, $PedidoFolio)
{
  ...
  $sqlCmd = "SELECT a.pe_of,a.pe_lin,trim(a.pe_clave) pe_clave,a.pe_letra,trim(a.pe_ped) pe_ped,
    ...
    a.pe_cansu,a.pe_grasu,a.pe_serie,a.pe_nufact,a.pe_fete,a.pe_canpro,a.pe_gpo,a.pe_cat,a.pe_scat,
    ...
    a.pe_mpx,a.pe_cpx,
    trim(b.c_descr) cpt_descr,c.pe_fepep,c.pe_canpe,c.pe_canpe pe_canpep,c.pe_grape pe_grapep,
  ...
  if(count($data)>0){
    ...
    foreach($data as $row){
      ...
      $pedidos = [
          ...
          "DiferenciaSurtido" => $row["pe_canpe"] - $row["pe_cansu"],
          "FacturaSerie" => $row["pe_serie"],
          "FacturaFolio" => $row["pe_nufact"],
          "FechaTerminacionArticulo" => $row["pe_fete"],
          "CantidadMedida4" => $row["pe_cp4"],
          "CantidadMedida4_5" => $row["pe_cp45"],
          "CantidadMedida5" => $row["pe_cp5"],
          "CantidadMedida5_5" => $row["pe_cp55"],
          "CantidadMedida6" => $row["pe_cp6"],
          "CantidadMedida6_5" => $row["pe_cp65"],
          "CantidadMedida7" => $row["pe_cp7"],
          "CantidadMedida7_5" => $row["pe_cp75"],
          "CantidadMedida8" => $row["pe_cp8"],
          "CantidadMedida8_5" => $row["pe_cp85"],
          "CantidadMedida9" => $row["pe_cp9"],
          "CantidadMedida9_5" => $row["pe_cp95"],
          "CantidadMedida10" => $row["pe_cp10"],
          "CantidadMedida10_5" => $row["pe_cp105"],
          "CantidadMedida11" => $row["pe_cp11"],
          "CantidadMedida11_5" => $row["pe_cp115"],
          "CantidadMedida12" => $row["pe_cp12"],
          "CantidadMedida12_5" => $row["pe_cp125"],
          "CantidadMedida13" => $row["pe_cp13"],
          "MedidaEspecial" => $row["pe_mpx"],
          "CantidadMedidaEspecial" => $row["pe_cpx"],
          "FechaPedidoProduccion" => $row["pe_fepep"],          
          "CantidadPedidoProduccion" => is_null($row["pe_canpep"]) ? 0 : $row["pe_canpep"],
          "CantidadProducida" => is_null($row["pe_canpro"]) ? 0 : $row["pe_canpro"],
          "DiferenciaProducido" => $row["pe_canpep"] - $row["pe_canpro"],
